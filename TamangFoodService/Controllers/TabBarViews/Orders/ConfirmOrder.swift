...
struct ConfirmOrder: View {
    ...
    @State private var isHVActive = false
                ...
                VStack {
                    ...
                    ScrollView(showsIndicators: false) {
                        ...
                        Button {
                            ...
                            BigYellowButton(buttonTitle: "CHECKOUT (AUD $30)", isBold: true)
                                .padding(.horizontal, 34)
                        }
                    }
                    if isHVActive {
                        OrderCompleted(isPresented: $isHVActive)
                            .frame(height: 350)
...
#Preview {
    ConfirmOrder(orderData: orderModelDummyData)
}
